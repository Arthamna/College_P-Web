                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="session/logout.php">Log Out <span class="glyphicon glyphicon-off"></span></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        <div id="wrapper">            
            ...
            <div id="sidebar-wrapper">
                <ul class="sidebar-nav">
                    ...
                    <li>
                        <a href="masuk"><span class="glyphicon glyphicon-list-alt"></span> Laundry Masuk</a>
                    </li>
                    <li>
                        <a href="keluar"><span class="glyphicon glyphicon-shopping-cart"></span> Laundry Keluar</a>
                    </li>                    
                    <li>
