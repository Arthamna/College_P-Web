...
Pada pertemuan kali ini, diberikan latihan untuk membuat arsitektur aplikasi web dari tugas minggu sebelumnya. Maka, berikut adalah representasi 3-layer architecture dari  ( Aplikasi Web Management Data Siswa + Foto dengan CRUD ) 


![](/Pertemuan13/imgs/arsi.png)
...
Pemetaan file aplikasi per layer :
